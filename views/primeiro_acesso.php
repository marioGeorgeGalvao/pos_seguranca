			...
			<div class="wrap-login100 p-l-40 p-r-40 p-t-70 p-b-20">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 m-b-16" >
						<input class="input100" type="text" name="matricula" placeholder="Sua matricula" required>
                    ...
                    <?php if(isset($error) && (!empty($error))): ?>
					    <label class="wrap-input100" style="text-align:center;" >
							<!-- Atenção, acesso já existente. <a href="<?php echo BASE_URL;?>/login">Tela de Login</a> -->
							Link enviado para o e-mail cadastro para nova senha. <a href="<?php echo BASE_URL;?>/login">Tela de Login</a>
						</label>
					<?php endif; ?>

                    <?php if(isset($success) && (!empty($success))): ?>
					    <label class="wrap-input100" style="text-align:center;" >
							<!-- Cadastro realizado. <a href="<?php echo BASE_URL;?>/login">Tela de Login</a> -->
							Link enviado para o e-mail cadastro para nova senha.
						</label>
					<?php endif; ?>

                    <?php if(isset($sem_matricula) && (!empty($sem_matricula))): ?>
					    <label class="wrap-input100" style="text-align:center;" >
